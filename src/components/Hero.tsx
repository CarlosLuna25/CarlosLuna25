...
export const Hero = () => {
  ...
  useGSAP(() => {
    ...
    mm.add("(prefers-reduced-motion: no-preference)", () => {
      ...
      tl.from('.hero-badge', { y: -20, opacity: 0, duration: 0.6, ease: "power3.out" })
        .from('.hero-tagline', { opacity: 0, duration: 0.4 }, "-=0.2")
        ...
        .from('.hero-cta', { y: 20, opacity: 0, duration: 0.6, stagger: 0.1, ease: "power2.out" }, "-=0.4")
        .from('.hero-graphic', { x: 30, opacity: 0, duration: 1, ease: "power3.out" }, "-=0.6");
    });
  }, { scope: containerRef });
  ...
  return (
    <header ref={containerRef} className="max-w-7xl mx-auto mb-24 flex flex-col lg:flex-row items-center justify-between gap-12 px-4 md:px-8 lg:px-12 relative">
      ...
      <div className="lg:w-2/3 space-y-8 relative z-10">
        {/* Status Badge */}
        <div className="hero-badge inline-flex items-center gap-3 glass-card px-4 py-2 border-accent-cyan/30">
        ...
        {/* Tag Line */}
        <div>
          <span className="hero-tagline font-mono text-gray-500 text-sm mb-3 block tracking-widest uppercase">
            // Full Stack Architect
          </span>

          <h1 className="hero-title text-5xl md:text-7xl lg:text-8xl font-black leading-none mb-6 scroll-mt-24" style={{ textWrap: 'balance' }}>
            Construyo arquitecturas <br />
            <span className="gradient-text">escalables</span> que <br />
            cobran vida.
          </h1>

          <p className="hero-desc text-gray-400 text-lg md:text-xl max-w-xl leading-relaxed mb-8" style={{ textWrap: 'pretty' }}>
        ...
        <div className="flex flex-wrap gap-6 items-center">
          <div className="hero-cta">
            <button
              ...
              className="group relative bg-accent-cyan text-black border border-transparent px-8 py-4 rounded-full font-bold text-sm hover:bg-white transition-colors focus-visible:ring-2 focus-visible:ring-accent-cyan focus-visible:ring-offset-2 overflow-hidden"
            >
          ...
          <div className="hero-cta">
            <button
              ...
              className="group glass-card px-8 py-4 rounded-full font-bold text-sm text-white hover:bg-white/10 hover:border-accent-purple/50 transition-colors focus-visible:ring-2 focus-visible:ring-accent-purple focus-visible:ring-offset-2"
            >
      ...
      <div className="hero-graphic lg:w-1/3 flex justify-center relative sm:w-full w-full">
